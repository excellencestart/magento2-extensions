...
namespace Excellencestar\InvisibleCaptcha\Plugin;
...
class Predispatch
{
    ...
    public function __construct(
        ...
        \Excellencestar\InvisibleCaptcha\Model\Captcha $captchaModel,
        ...
        if ($this->captchaModel->isNeedToShowCaptcha()) {
            foreach ($this->configProvider->getAllUrls() as $captchaUrl) {
                if ($request->isPost()
                    ...
                    $token = $request->getPost('captcha_invisible_token');
